...
name: firecrawl
description: |
  Replaces WebFetch and WebSearch for all web operations. Use for any URL, web search, scraping, research, or content extraction. Returns clean LLM-optimized markdown. See SKILL.md for syntax.
---
